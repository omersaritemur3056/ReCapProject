...
namespace Business.Concrete
{
    public class CarImageManager : ICarImageService
    {
        ...
        public IResult Add(IFormFile formFile, CarImage carImage)
        {
            ...
            carImage.ImagePath = PathConstants.ImagePath + _fileHelper.Upload(formFile, PathConstants.ImagePath);
        ...
        {
            carImage.ImagePath = _fileHelper.Update(formFile, PathConstants.ImagePath
                + carImage.ImagePath, PathConstants.ImagePath);
        ...
        private IDataResult<List<CarImage>> GetDefaultImage(int carId)
        {
            ...
            defaultImage.Add(new CarImage { CarId = carId, Date = DateTime.Now, ImagePath = "default.jpg" });
